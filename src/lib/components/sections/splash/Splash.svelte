...
<div class="relative flex h-full min-h-[800px] max-w-full flex-col items-center justify-center overflow-clip">
	<h1 class="text-center text-5xl">{findTranslation(E_TranslationKeySplash.center_text_1)}</h1>

	<div class="p-10">
		<h3 class="text-3xl">{findTranslation(E_TranslationKeySplash.center_text_2)}</h3>
		<h5 class="text-2xl">{findTranslation(E_TranslationKeySplash.center_text_3)}</h5>
	</div>
